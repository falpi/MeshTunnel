...
namespace MeshTunnel
{
    public class MeshMapper
    {
        ...
        public void start(MeshServer parent, int protocol, int localPort, string url, int remotePort, string? remoteIP)
        {
            this.parent = parent;
        ...
        private void UpdateInfo() {
            ...
            //    if (remoteip == null)
            //    {
            //        msg = string.Format(Properties.Resources.PortXtoPortY, localport, remoteport);
            //    } else {
            //        msg = string.Format(Properties.Resources.PortXtoIPPortY, localport, remoteip, remoteport);
            //    }
        ...
        private void Wc_onStringData(WebSocketClient sender, string data, int orglen)
        {
            ...
            else if (sender.tunneling == true)
            {
                ...
                try { jsonAction = JsonHelper.Deserialize(data); } catch (Exception) { }
        ...
        private void ClientEndWrite(IAsyncResult ar)
        {
            ...
            (ar.AsyncState as WebSocketClient)?.Resume();
        }
